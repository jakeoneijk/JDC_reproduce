...
class JDCModel():
    ...
    def get_jdc_model(self):
        input = Input(shape=(self.options.input_size, self.options.num_spec,1))
        block_1, block_2, block_3, block_4, output_pitch = self.main_network(input)
        output_voice = self.auxiliary_network(block_1, block_2, block_3, block_4, output_pitch)
    ...
    def main_network(self, input_form):
        ...
        return block_1, block_2, block_3, block_4, output
